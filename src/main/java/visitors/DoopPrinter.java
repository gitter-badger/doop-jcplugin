...
// Ths is a hacked version of the Pretty.java visitor in com.sun.tools.javac.tree for experimentation.
 ...
 */
public class DoopPrinter extends JCTree.Visitor {
    /**
...
//    }
    ...
    public DoopPrinter(Writer out, boolean sourceOutput) {
        this.out = out;
        this.sourceOutput = sourceOutput;
        String primitiveTypesArray[] = new String[]{"int", "int[]",
                "boolean", "boolean[]",
                "byte", "byte[]",
                "short", "short[]",
                "float", "float[]",
